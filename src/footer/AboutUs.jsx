            ...
            <div>
                <h2 className="font-bold text-3xl md:text-5xl text-green-900">About Us</h2>
                    ...
                    <div className="border rounded-lg hover:shadow-md border-green-900 my-5">
                        <h3 className="m-7 bg-green-800 p-2 rounded-md font-semibold text-2xl md:text-3xl text-white">Welcome to SecondMat 🌱</h3>
                    ...
                    <div className="border rounded-lg hover:shadow-md border-green-900 my-5">
                        <h3 className="m-7 bg-green-800 p-2 rounded-md font-semibold text-2xl md:text-3xl text-white">Why We Exist</h3>
                    ...
                    <div className="border rounded-lg hover:shadow-md border-green-900 my-5">
                        <h3 className="m-7 bg-green-800 p-2 rounded-md font-semibold text-2xl md:text-3xl text-white">Our Vision</h3>
                    ...
                    <div className="border rounded-lg hover:shadow-md border-green-900 my-5">
                        <h3 className="m-7 bg-green-800 p-2 rounded-md font-semibold text-2xl md:text-3xl text-white">Join Us</h3>
                    ...
                    <div className="border rounded-lg hover:shadow-md border-green-900 my-5" id="contact">
                        <h3 className="m-7 bg-green-800 p-2 rounded-md font-semibold text-2xl md:text-3xl text-white">Contact Information</h3>
                        <ul>
                            <li>
