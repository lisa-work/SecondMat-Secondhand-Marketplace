  ...
  return (
    <div>
        ...
        <div className="p-10 md:px-20">
            <h2 className="font-bold lg:text-4xl text-3xl text-green-900">{location}</h2>
...
export default SearchItemsNearby