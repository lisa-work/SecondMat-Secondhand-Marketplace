...
function SearchSeller() {
    ...
    const handleClick = () => {
    window.location.href = "/search-same-seller?seller="+seller+"&category="+category+"&keyword="+keyword+"&price="+price+"&condition="+condition+"&location="+location;
    }
...
useEffect(() => {
  ...
  const initialSeller = params.get('seller') || "";
  ...
  console.log("Search by: ", keyword, condition, location, category, price, seller)   
}, []);
